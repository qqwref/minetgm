...
var appData = {
    ...
    FIRST_TORIKAN: 300000, // PB 93.370 (9.515, 26.825, 41.665, 65.101, 93.370)
...
vueApp = new Vue({
    ...
    methods: {
        ...
        nextLevel: function(y, x) {
            ...
            this.m = this.mineCount;
            this.remainingMines = this.m;
			this.allowFlags = !this.noFlags;
			this.showNumbers = !this.noNumbers;
			this.colorRestriction = this.randomColors ? 1 : 0;
